...
public class QRCodeUtils {
     ...
     */
    @Nullable
    public static Bitmap createQRCodeBitmap(String content, int width, int height, @ColorInt int color_black) {
        return createQRCodeBitmap(content, width, height, "UTF-8", "H", "2", color_black, Color.WHITE);
    }
